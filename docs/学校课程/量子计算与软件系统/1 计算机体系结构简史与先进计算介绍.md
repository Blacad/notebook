...
- 图灵奖得主、计算机体系结构领域杰出人物 John L. Hennessy 和 David A. Patterson 也指出“随着摩尔定律走向极限，设计新的计算硬件架构及其编程软件系统将成为提升计算机效能的核心技术”
...
- 设备繁杂
- 计算存在噪声
	- 误差大概是 0.1 %，而电子比特误差是 $10^{-12} - 10^{-13}$
- 只能在特定任务上取得量子计算优势
...
- 量子力学的两个流派
	...
	- 经典物理派 --- 爱因斯坦
		- 不存在概率，只是有隐变量不知道
	- 2022年诺贝尔物理学奖
		- 通过**纠缠光子实验**验证了**贝尔不等式的违背**，并推动了**量子信息科学**的发展
		- 两个相互纠缠的粒子，即使相距很远，对它们的测量结果仍会表现出超越经典物理所允许的强关联。这类实验排除了大量基于“局域隐变量”的经典解释，为量子力学的基本理论提供了重要实验支持
...
-  叠加态 $|\psi\rangle=\alpha|0\rangle+\beta|1\rangle$，即

    $$
    |\psi\rangle=\begin{bmatrix}\alpha\\\beta\end{bmatrix}
    $$

    在该式中，$\alpha$ 和 $\beta$ 被称为**复系数**（有时被称为振幅），它们描述了量子比特的叠加状态，它们是复数。

- 量子门
	- 量子非门 2x2 矩阵
	- 量子异或门 4x4 矩阵
	- 其它多种量子门逻辑操作
- 更详细的内容在 [2 量子态与量子门](量子计算与软件系统/2%20量子态与量子门.md)
